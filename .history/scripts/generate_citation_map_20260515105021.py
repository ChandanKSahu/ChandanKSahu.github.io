...
def format_citations_rounded(total: int) -> str:
    """Format total citations to the highest 100× multiplier below, with '+'.
...
def fetch_author_profile(name: str):
    try:
        ...
        try:
            ...
            try:
                ...
                for i, citation in enumerate(citations_iter):
                    ...
                    c_author_names = [a.strip() for a in bib.get("author", "").split(" and ") if a.strip()]
