...
.career-rail__node--short-connector.career-rail__node--bottom .career-rail__connector {
  bottom: 14px;
}
.career-rail__hit {
  position: absolute;
...
.career-rail__hit--plain {
  background: transparent;
  box-shadow: none;
  border-radius: 0;
  padding: 0;
}
.career-rail__hit--plain:hover,
.career-rail__hit--plain:focus {
  box-shadow: none;
}
.career-rail__node--current .career-rail__hit {
  box-shadow: 0 0 0 3px #494e52, 0 4px 14px rgba(0,0,0,0.18);
}
.career-rail__node--current .career-rail__hit--plain {
  box-shadow: none;
}
.career-rail__year {
  position: absolute;
  ...
  <div class="career-rail__inner">
    ...
    <ol class="career-rail__nodes">
      ...
      <li class="career-rail__node career-rail__node--bottom career-rail__node--current career-rail__node--short-connector">
        <span class="career-rail__connector" aria-hidden="true"></span>
        <button type="button" class="career-rail__hit career-rail__hit--plain" aria-label="ABB 2025 to present">
...
- **CAD Modeling**: AI-assisted design workflows for processing engineering drawings and 3D CAD models
